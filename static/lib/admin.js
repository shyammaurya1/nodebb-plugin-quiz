...
define('admin/plugins/quiz', [], function () {
	var admin = {};

	function addCloseHandler() {
		$('#quiz .fa-times').on('click', function () {
			$(this).parents('.well').remove();
		});
	}

	function addTagsInputForGroups(el) {
		el = el || $('#quiz .groups-list');
		...
		app.loadJQueryUI(function () {
			var input = $('.page-admin-quiz .bootstrap-tagsinput input');
			input.autocomplete({
				delay: 100,
